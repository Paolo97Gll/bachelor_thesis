...
# Find best LGB hyper-parameters (sorted) (HyperOpt)
...
# On file
with open('ris/HyperOpt_out_s.md', mode='a') as f:
...
params = {'chat_id': telegram_bot_id['chat_id'], 'text': '[python] LGB HyperOpt sorted terminated.'}
